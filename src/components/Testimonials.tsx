...
const testimonials = [
  ...
  },
  {
    ...
    loanType: 'Debt Consolidation',
    date: '01/16/25',
    text: 'Seamless Loan Consolidation and Excellent Support".\n\nI had an excellent experience with Easy Personal Loan Services. Team was incredibly helpful in explaining everything clearly, from gathering details of all my outstanding personal loans and credit cards to ensuring the calculations were accurate. Now I just need to Pay SIngle EMI.',
    initial: 'S',
  },
  {
    name: 'Priya S',
    ...
    date: '03/12/25',
    text: 'Getting a loan for our home renovation was so easy and quick. The team was very supportive and guided us at every step. We are very happy with the service.',
    initial: 'P',
  },
  {
    name: 'Amit Kumar',
    ...
    date: '04/05/25',
    text: 'We were short on funds for our wedding, but Easy Personal Loan Services came to our rescue. The loan was approved in no time, and the process was very transparent. Highly recommended!',
    initial: 'A',
  },
];
...
const Testimonials = () => {
  ...
  return (
    <div className="max-w-[1300px] mx-auto px-4 py-6 relative">
        ...
        What our <span className="text-blue-600">customers</span> say about us
            ...
            <div className="overflow-hidden w-full relative">
              <div
                ...
                className="flex space-x-6 overflow-x-auto overflow-y-hidden snap-x snap-mandatory scroll-smooth scrollbar-hide"
              >
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    ...
                    <p className="text-[#292a2d] text-sm mt-4 font-medium leading-relaxed">
                      {testimonial.text}
                    </p>
                  </div>
                ))}
              ...
              <div className="absolute top-1/2 -translate-y-1/2 flex justify-between w-full px-4">
                <button onClick={scrollLeft} className="bg-white rounded-full p-2 shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                  </svg>
                </button>
                <button onClick={scrollRight} className="bg-white rounded-full p-2 shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex justify-center mt-8">
              <a
                href="https://www.justdial.com/Bangalore/Easy-Personal-Loan-Services-Krishnarajapuram/080PXX80-XX80-101118132013-F7J8_BZDET"
                target="_blank"
              ...
              >
                View More Reviews on Just Dial
              </a>
            </div>
          </div>
        );
