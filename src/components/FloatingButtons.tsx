...
const FloatingButtons = () => {
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col items-center space-y-4">
      ...
      <a
        href="tel:+918722545666"
        className="bg-blue-500 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:bg-blue-600 transition-all"
        aria-label="Call us"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
