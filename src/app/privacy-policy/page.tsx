    ...
    <div>
      <div className="max-w-[1294px] mx-auto px-4 mt-10">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-8 text-center">
          Privacy <span className="text-blue-550">Policy</span>
        </h1>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="prose max-w-none text-gray-700">
            ...
            <p className="mb-4">We automatically collect certain information about your device when you visit our website:</p>
            <ul className="list-disc pl-6 mb-6">
            ...
            <ul className="list-disc pl-6 mb-6">
                ...
                <li>To process loan applications</li>
            ...
            <ul className="list-disc pl-6 mb-6">
                <li><strong>Service Providers:</strong> We may share information with banks and financial institutions for loan processing</li>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
                <p><strong>Email:</strong> support@easypersonalloanservices.com</p>
                <p><strong>Phone:</strong> +91 8722545666</p>
                <p><strong>Address:</strong> No 326/3 3rd Floor, Vandana Complex, New Bazar Street, Krishnarajapuram-560036</p>
            </div>
          </div>
        </div>
      </div>
